package backend.example.notificationservice.exception;
...
public enum ErrorCode {
    ...
    INVALID_KEY(1001, "Uncategorized er ror", HttpStatus.BAD_REQUEST),
    ...
    CANNOT_SEND_EMAIL(1014, "Cannot send email", HttpStatus.BAD_REQUEST)
